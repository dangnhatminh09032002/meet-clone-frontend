...
import { VideoPresets, Room, RoomEvent, RemoteTrackPublication } from "livekit-client";
...
export function RoomPage() {
    ...
    // console.log(room.LocalTrackPublication);
    ...
    //             `http://localhost:8080/api/room/is-room-master/${room_id}`,
    //             { withCredentials: true }
    //         );
    //         // console.log(res);
    //         setIsHost(res.data.data);
    //     }
    //     getHost();
    // },[])
