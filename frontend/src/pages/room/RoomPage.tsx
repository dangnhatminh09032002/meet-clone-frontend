        ...
        <div className='glo-page'>
            ...
            <div className='rightRoom'>
                <div className='containerFrame'>
                    <div
                        className='wrapJoin'
                        style={type === 'join' && showJoin ? displayStyle : displayNoneStyle}
                    >
                        <FrameJoinRoom
                    ...
                    <div
                        className='wrapChat'
                        style={type === 'chat' && showChat ? displayStyle : displayNoneStyle}
                    >
                        <div className='glo-checkChat'>
                            <FrameChat room={room} hourAndMinute={hourAndMinute} />
                        </div>
                    </div>

                    <div
                        className='wrapUser'
                        style={type === 'user' && showUsers ? displayStyle : displayNoneStyle}
                    >
                        <FrameShowUsers />
                    </div>
                    ...
                    <div
                        className='wrapInfo'
                        style={type === 'info' && showInfo ? displayStyle : displayNoneStyle}
                    >
                        <FrameInfoRoom />
                    </div>
                </div>
                <div className='frameControlRight'>
                    <div className='controlItem' onClick={clickButtonJoin}>
                        <HailIcon
                            style={type === 'join' ? controlItemActive : controlItemNoActive}
                            className='controlItem'
                        />
                        <span className='controlNumberJoin'>{numberPrejoin}</span>
                    </div>
                    <div className='controlItem' onClick={clickButtonInfo}>
                        <InfoIcon
                            style={type === 'info' ? controlItemActive : controlItemNoActive}
                        />
                    </div>
                    <div className='controlItem' onClick={clickButtonUser}>
                        <GroupIcon
                            style={type === 'user' ? controlItemActive : controlItemNoActive}
                        />
                        <span className='controlNumberCount'>{numParticipants}</span>
                    </div>
                    <div className='controlItem' onClick={clickButtonMessage}>
                        <ChatBubbleIcon
                            style={type === 'chat' ? controlItemActive : controlItemNoActive}
                            className='controlItem'
                        />
                    </div>
                </div>
