      ...
      <div className="rightRoom">
        <div className="containerFrame">
          <div
            className="wrapJoin"
            style={
              type === "join" && showJoin ? displayStyle : displayNoneStyle
            }
          >
            <FrameJoinRoom
          ...
          <div
            className="wrapChat"
            style={
              type === "chat" && showChat ? displayStyle : displayNoneStyle
            }
          >
          ...
          <div
            className="wrapUser"
            style={
              type === "user" && showUsers ? displayStyle : displayNoneStyle
            }
          >
            <FrameShowUsers />
          </div>
          ...
          <div
            className="wrapInfo"
            style={
              type === "info" && showInfo ? displayStyle : displayNoneStyle
            }
          >
            <FrameInfoRoom />
          </div>
